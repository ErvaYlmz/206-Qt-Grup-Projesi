...
bool Ghost::active(){
    ...
    if (player2->getPosX() + 30 < this->getPosX()
        &&  player2->getPosY() + 64 > this->getPosY()
        && player2->getPosX() + 84 > this->getPosX()
        &&  player2->getPosY()  < this->getPosY() )
    {
        timer->stop();
        int point ;
        point = player2->getScore();
        point = point+1;
        player2->setScore(point);
    }
